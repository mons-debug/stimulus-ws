    ...
    <>
      ...
      <section className="relative bg-navy overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-center min-h-screen pt-16 pb-4 lg:pt-28 lg:pb-12">
            ...
            <div className="text-center lg:text-right order-1">
              ...
              <h1 className="text-[28px] sm:text-5xl lg:text-7xl font-extrabold text-white leading-[1.1] mb-2 lg:mb-6">
                <WavyText text="منظمة مجموعات" /><br /><WavyText text="التحفيز" className="text-coral" delay={0.4} />
              </h1>
              <p className="text-white/60 text-[11px] lg:text-lg leading-relaxed mb-3 lg:mb-10 max-w-lg mx-auto lg:mr-0">
