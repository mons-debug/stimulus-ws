...
const VALUES = [
  { num: "٠١", title: "الحرية", desc: "نؤمن بالحرية كأساس لأي عمل بحثي. لا انتماء حزبي ولا أجندة خفيّة." },
  { num: "٠٢", title: "الشفافية", desc: "منهجياتنا ومصادر تمويلنا وتقاريرنا المالية كاملةً متاحة للجميع." },
  { num: "٠٣", title: "الاحتراف", desc: "احترام العلم والتخصص والاحتراف في كل ما ننتجه من أبحاث ودراسات." },
  { num: "٠٤", title: "المجتمع أولاً", desc: "المجتمع الفعال قبل السلطة القوية. نؤمن بتقوية المجتمع كضمانة للحوكمة الرشيدة." },
  { num: "٠٥", title: "التعاون", desc: "نستثمر في الشراكات والتعاون مع التنوع لتحقيق أثر أكبر وأعمق." },
  { num: "٠٦", title: "الجيل القادم", desc: "نستثمر في الشباب لأن استمرار العمل البحثي مرهون باستمرار من يقوم به." },
];
